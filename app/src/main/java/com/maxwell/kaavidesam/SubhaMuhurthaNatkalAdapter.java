...
public class SubhaMuhurthaNatkalAdapter extends RecyclerView.Adapter<SubhaMuhurthaNatkalAdapter.ViewHolder>{

    List<SubaMuhurthaNatkalModel> subaMuhurthaNatkalModelList;
    Context context;

    public SubhaMuhurthaNatkalAdapter(Context mcontext, List<SubaMuhurthaNatkalModel> subaMuhurthaNatkalModelList){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View listItem= layoutInflater.inflate(R.layout.layout_subha_muhurtha_natkal_row, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.tv_time.setText(teamModel.getFromTime()+" - "+teamModel.getToTime());
      ...
      String  selectedWeek =format2.format(dt);
        ...
        if(selectedWeek.matches("Sunday")){
            viewHolder.tv_day.setText(date[0]+"ஞாயிறு");

        } if(selectedWeek.matches("Monday")){
            viewHolder.tv_day.setText(date[0]+" திங்கள்");

        } if(selectedWeek.matches("Tuesday")){
            viewHolder.tv_day.setText(date[0]+" செவ்வாய்");
            // tv_day.setText("செவ்வாய்");
        } if(selectedWeek.matches("Wednesday")){
            viewHolder.tv_day.setText(date[0]+" புதன்");

        } if(selectedWeek.matches("Thursday")){
            viewHolder.tv_day.setText(date[0]+" வியாழன்");

        } if(selectedWeek.matches("Friday")){
            viewHolder.tv_day.setText(date[0]+" வெள்ளி");

        } if(selectedWeek.matches("Saturday")){

            viewHolder.tv_day.setText(date[0]+" சனிக்கிழமை");
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView tv_month, tv_date, tv_tamil_month, tv_time, tv_day,tv_information;
